...
class UserApi:
    ...
    async def create_user_with_http_info(
        self, user_create: UserCreate, **kwargs
    ...
    async def create_users_with_list(
        self, user_create: conlist(UserCreate), **kwargs
    ) -> List[User]:  # noqa: E501
    ...
    @validate_call
    async def create_users_with_list_with_http_info(
        self, user_create: conlist(UserCreate), **kwargs
    ) -> ApiResponse:  # noqa: E501
        """Create Users With List  # noqa: E501
    ...
    async def create_users_with_list_without_validation(
        self, user_create=None, **kwargs
    ) -> ApiResponse:  # noqa: E501
    ...
    async def delete_user_without_validation(
    ...
    async def get_user_by_name_without_validation(
        self, username=None, **kwargs
    ) -> ApiResponse:  # noqa: E501
    ...
    async def login_user(
        self,
        username: Annotated[
            StrictStr, Field(..., description="The username for login")
        ],
        password: Annotated[
            StrictStr, Field(..., description="The password for login")
        ],
        **kwargs,
    ...
    async def login_user_without_validation(
    ...
    async def update_user(
        self, username: StrictStr, user_update: UserUpdate, **kwargs
    ) -> User:  # noqa: E501
    ...
    async def update_user_with_http_info(
        ...
        _all_params = ["username", "user_update"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
    ...
    async def update_user_without_validation(
        self, username=None, user_update=None, **kwargs
    ) -> ApiResponse:  # noqa: E501
