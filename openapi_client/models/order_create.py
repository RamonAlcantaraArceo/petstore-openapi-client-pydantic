...
class OrderCreate(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.pet_id is None and "pet_id" in self.__fields_set__:
            _dict['pet_id'] = None
        ...
        # and __fields_set__ contains the field
        if self.ship_date is None and "ship_date" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.complete is None and "complete" in self.__fields_set__:
            _dict['complete'] = None
