...
Health check response payload.  Attributes:     status: Service status string.     mode: Storage mode.     details: Build and version metadata.
...
**status** | **str** |  | 
**mode** | **str** |  | 
**details** | [**HealthDetails**](HealthDetails.md) |  | 
